...
def rag_query(user_query: str, docs: List[str], index, embedder, top_k=3):
    try:
        ...
        prompt = f"""Você é um assistente da torcida do time de CS da FURIA. Com base nas informações abaixo, responda de maneira clara e completa o que foi perguntado.
                    ...
                    Caso a pergunta não seja relacionada ao time de CS da Furia, responda que você apenas ajuda os torcedors com questões relacionadas ao time.

                    IMPORTANTE: Não faça menções as informações fornecidas, lembre-se: Você é o especialista.
